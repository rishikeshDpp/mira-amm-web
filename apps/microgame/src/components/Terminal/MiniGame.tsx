...
const MiniGame = ({ terminal }: MiniGameProps) => {
  ...
  useEffect(() => {
    if (!state.gameActive && !showWalletInput && state.highScore && state.currentScore === state.highScore) {
  ...
  return (
    <div className="mini-game">
      ...
      <div className="game-canvas-container border-4 border-terminal-blue flex items-center justify-center mb-6 bg-black/30 relative overflow-hidden">
        ...
        <Game onStart={startGame} onChangScore={updateGameScore} onExit={endGame} onOver={endGame} />
          ...
          <div className="text-center">
            ...
            {!showWalletInput && (
              <pre className="text-terminal-green font-bold animate-pulse">
                ________________________ / \ | PRESS TRANSACTION KEY | | TO BEGIN SIMULATION |
        ...
        <div className="flex justify-between p-2">
          <div className="flex items-center">
            ...
            <p className="text-terminal-green font-bold">
              TRADE PROFIT: <span className="text-terminal-green animate-pulse">${state.currentScore}</span>
            </p>
          </div>
          <div className="flex items-center">
            <p className="text-terminal-green font-bold">
              COMMISSION: <span className="text-terminal-blue animate-pulse">x{state.multiplier}</span>
            </p>
      ...
      <PaginationContextProvider initialPage={1} fetchData={async () => { }} pageSize={50}>
        {({ currentPage, setCurrentPage }) => (
          <>
            ...
            <div className="mt-4 flex justify-center">
              <Pagination currentPage={currentPage} onChange={setCurrentPage} totalPages={100} />
            </div>
          </>
        )}
